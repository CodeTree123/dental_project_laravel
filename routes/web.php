...
Route::post('/new/patient',[MainController::class,'patient_info'])->name('patient_info');
//search patient
...
Route::get('/view/patient/treatment/{p_id}/{t_id}/{t_plans}',[MainController::class,'treatments'])->name('treatments');
Route::post('/view/patient/treatment/{p_id}/{t_id}/{t_plans}',[MainController::class,'treatments'])->name('treatments');

Route::get('/view/patient/prescription/{p_id}/{t_id}/{t_plans}',[MainController::class,'prescription'])->name('prescription');
